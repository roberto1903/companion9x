...
int8_t open9xx9dFromSwitch(const RawSwitch & sw)
{
  switch (sw.type) {
...
RawSwitch open9xx9dToSwitch(int8_t sw)
{
  uint8_t swa = abs(sw);
  if (swa == 0)
...
int8_t open9xx9d208FromSource(RawSource source)
{
  int v1 = 0;
...
RawSource open9xx9d208ToSource(int8_t value)
{
  if (value == 0) {
...
int8_t open9xx9d209FromSource(RawSource source)
{
  int v1 = 0;
  if (source.type == SOURCE_TYPE_STICK)
    v1 = 1+source.index;
...
RawSource open9xx9d209ToSource(int8_t value)
{
  if (value == 0) {
    return RawSource(SOURCE_TYPE_NONE);
  }
...
int8_t open9xx9d210FromSource(RawSource source)
{
  int v1 = 0;
  if (source.type == SOURCE_TYPE_STICK)
    v1 = 1+source.index;
...
RawSource open9xx9d210ToSource(int8_t value)
{
  if (value == 0) {
    return RawSource(SOURCE_TYPE_NONE);
  }
...
t_Open9xx9dGeneralData_v208::t_Open9xx9dGeneralData_v208(GeneralSettings &c9x, unsigned int version, unsigned int variant)
{
  memset(this, 0, sizeof(t_Open9xx9dGeneralData_v208));
...
Open9xx9dGeneralData_v208::operator GeneralSettings ()
{
...
t_Open9xx9dGeneralData_v213::t_Open9xx9dGeneralData_v213(GeneralSettings &c9x, unsigned int version, unsigned int variant)
{
  memset(this, 0, sizeof(t_Open9xx9dGeneralData_v213));
...
Open9xx9dGeneralData_v213::operator GeneralSettings ()
{
  GeneralSettings result;
...
t_Open9xx9dTimerData_v202::operator TimerData ()
{
  TimerData c9x;
...
t_Open9xx9dTimerData_v202::t_Open9xx9dTimerData_v202(TimerData &c9x)
{
  val = c9x.val;
...
t_Open9xx9dTimerData_v213::operator TimerData ()
{
  TimerData c9x;
...
t_Open9xx9dTimerData_v213::t_Open9xx9dTimerData_v213(TimerData &c9x)
{
  start = c9x.val;
...
t_Open9xx9dExpoData_v208::t_Open9xx9dExpoData_v208(ExpoData &c9x)
{
  mode = c9x.mode;
  chn = c9x.chn;
  ...
  swtch = open9xx9dFromSwitch(c9x.swtch);
  int zeros=0;
  int ones=0;
...
t_Open9xx9dExpoData_v208::operator ExpoData ()
{
  ExpoData c9x;
  c9x.mode = mode;
  c9x.chn = chn;
  ...
  c9x.swtch = open9xx9dToSwitch(swtch);
  if (phase<0) {
...
t_Open9xx9dExpoData_v210::t_Open9xx9dExpoData_v210(ExpoData &c9x)
{
  mode = c9x.mode;
  chn = c9x.chn;
  // 0=no curve, 1-6=std curves, 7-10=CV1-CV4, 11-15=CV9-CV13
...
t_Open9xx9dExpoData_v210::operator ExpoData ()
{
  ExpoData c9x;
  c9x.mode = mode;
  c9x.chn = chn;
...
t_Open9xx9dExpoData_v212::t_Open9xx9dExpoData_v212(ExpoData &c9x)
{
  mode = c9x.mode;
  chn = c9x.chn;
  // 0=no curve, 1-6=std curves, 7-10=CV1-CV4, 11-15=CV9-CV13
...
t_Open9xx9dExpoData_v212::operator ExpoData ()
{
  ExpoData c9x;
  c9x.mode = mode;
  c9x.chn = chn;
...
t_Open9xx9dPhaseData_v208::operator PhaseData ()
{
  PhaseData c9x;
...
t_Open9xx9dPhaseData_v208::t_Open9xx9dPhaseData_v208(PhaseData &c9x)
{
  for (int i=0; i<NUM_STICKS; i++)
    trim[i] = c9x.trim[i];
  swtch = open9xx9dFromSwitch(c9x.swtch);
...
t_Open9xx9dPhaseData_v212::operator PhaseData ()
{
  PhaseData c9x;
  for (int i=0; i<NUM_STICKS; i++)
    c9x.trim[i] = trim[i];
...
t_Open9xx9dPhaseData_v212::t_Open9xx9dPhaseData_v212(PhaseData &c9x)
{
  for (int i=0; i<NUM_STICKS; i++)
    trim[i] = c9x.trim[i];
  swtch = open9xx9dFromSwitch(c9x.swtch);
...
t_Open9xx9dPhaseData_v213::operator PhaseData ()
{
  PhaseData c9x;
  for (int i=0; i<NUM_STICKS; i++)
    c9x.trim[i] = trim[i];
...
t_Open9xx9dPhaseData_v213::t_Open9xx9dPhaseData_v213(PhaseData &c9x)
{
  for (int i=0; i<NUM_STICKS; i++)
    trim[i] = c9x.trim[i];
  swtch = open9xx9dFromSwitch(c9x.swtch);
...
t_Open9xx9dMixData_v208::t_Open9xx9dMixData_v208(MixData &c9x)
{
  if (c9x.destCh) {
    destCh = c9x.destCh-1;
    mixWarn = c9x.mixWarn;
    ...
    if (c9x.srcRaw.type == SOURCE_TYPE_NONE) {
      ...
      srcRaw = 9 + open9xx9dFromSwitch(RawSwitch(c9x.srcRaw.index));
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_CYC) {
      srcRaw = 10+9+O9X_X9D_NUM_CSW + c9x.srcRaw.index;
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_PPM) {
      srcRaw = 10+9+O9X_X9D_NUM_CSW+NUM_CYC + c9x.srcRaw.index;
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_CH) {
      srcRaw = 10+9+O9X_X9D_NUM_CSW+NUM_CYC+NUM_PPM + c9x.srcRaw.index;
    }
    weight = c9x.weight;
    ...
    int ones=0;
    int phtemp=c9x.phases;
    for (int i=0; i<O9X_X9D_MAX_PHASES; i++) {
      if (phtemp & 1) {
        ones++;
      } else {
        zeros++;
    ...
    if (zeros==O9X_X9D_MAX_PHASES || zeros==0) {
      phase=0;
    } else if (zeros==1) {
      int phtemp=c9x.phases;
      int ph=0;
    ...
    memset(this, 0, sizeof(t_Open9xx9dMixData_v208));
  }
}

t_Open9xx9dMixData_v208::operator MixData ()
{
  MixData c9x;
  if (srcRaw) {
    c9x.destCh = destCh+1;
    ...
    else if (srcRaw <= 9+9+O9X_X9D_NUM_CSW) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_SWITCH, open9xx9dToSwitch(srcRaw-9).toValue());
    }
    else if (srcRaw <= 9+9+O9X_X9D_NUM_CSW+NUM_CYC) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_CYC, srcRaw-10-9-O9X_X9D_NUM_CSW);
    }
    else if (srcRaw <= 9+9+O9X_X9D_NUM_CSW+NUM_CYC+NUM_PPM) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_PPM, srcRaw-10-9-O9X_X9D_NUM_CSW-NUM_CYC);
    }
    else {
      c9x.srcRaw = RawSource(SOURCE_TYPE_CH, srcRaw-10-9-O9X_X9D_NUM_CSW-NUM_CYC-NUM_PPM);
    }
    c9x.weight = weight;
...
t_Open9xx9dMixData_v209::t_Open9xx9dMixData_v209(MixData &c9x)
{
  if (c9x.destCh) {
    destCh = c9x.destCh-1;
    mixWarn = c9x.mixWarn;
    ...
    if (c9x.srcRaw.type == SOURCE_TYPE_NONE) {
      ...
      srcRaw = 13 + open9xx9dFromSwitch(RawSwitch(c9x.srcRaw.index));
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_CYC) {
      srcRaw = 14+9+O9X_X9D_NUM_CSW + c9x.srcRaw.index;
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_PPM) {
      srcRaw = 14+9+O9X_X9D_NUM_CSW+NUM_CYC + c9x.srcRaw.index;
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_CH) {
      srcRaw = 14+9+O9X_X9D_NUM_CSW+NUM_CYC+NUM_PPM + c9x.srcRaw.index;
    }
    weight = c9x.weight;
    differential = c9x.differential/2;
    curve = c9x.curve;
    ...
    memset(this, 0, sizeof(t_Open9xx9dMixData_v209));
  }
}

t_Open9xx9dMixData_v209::operator MixData ()
{
  MixData c9x;
  if (srcRaw) {
    c9x.destCh = destCh+1;
    ...
    else if (srcRaw <= 13+9+O9X_X9D_NUM_CSW) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_SWITCH, open9xx9dToSwitch(srcRaw-13).toValue());
    }
    else if (srcRaw <= 13+9+O9X_X9D_NUM_CSW+NUM_CYC) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_CYC, srcRaw-14-9-O9X_X9D_NUM_CSW);
    }
    else if (srcRaw <= 13+9+O9X_X9D_NUM_CSW+NUM_CYC+NUM_PPM) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_PPM, srcRaw-14-9-O9X_X9D_NUM_CSW-NUM_CYC);
    }
    else {
      c9x.srcRaw = RawSource(SOURCE_TYPE_CH, srcRaw-14-9-O9X_X9D_NUM_CSW-NUM_CYC-NUM_PPM);
    }
    c9x.weight = weight;
    c9x.differential = differential*2;
    c9x.swtch = open9xx9dToSwitch(swtch);
...
t_Open9xx9dMixData_v210::t_Open9xx9dMixData_v210(MixData &c9x)
{
  if (c9x.destCh) {
    destCh = c9x.destCh-1;
    mixWarn = c9x.mixWarn;
    ...
    memset(this, 0, sizeof(t_Open9xx9dMixData_v210));
  }
}

t_Open9xx9dMixData_v210::operator MixData ()
{
  MixData c9x;
  if (srcRaw) {
    c9x.destCh = destCh+1;
...
t_Open9xx9dMixData_v212::t_Open9xx9dMixData_v212(MixData &c9x)
{
  if (c9x.destCh) {
    destCh = c9x.destCh-1;
    mixWarn = c9x.mixWarn;
    ...
    if (c9x.srcRaw.type == SOURCE_TYPE_NONE) {
      ...
      srcRaw = 14 + open9xx9dFromSwitch(RawSwitch(c9x.srcRaw.index));
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_CYC) {
      srcRaw = 15+9+O9X_X9D_NUM_CSW + c9x.srcRaw.index;
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_PPM) {
      srcRaw = 15+9+O9X_X9D_NUM_CSW+NUM_CYC + c9x.srcRaw.index;
    }
    else if (c9x.srcRaw.type == SOURCE_TYPE_CH) {
      srcRaw = 15+9+O9X_X9D_NUM_CSW+NUM_CYC+NUM_PPM + c9x.srcRaw.index;
    }
    weight = c9x.weight;
    if (c9x.curve==0) {
      curveMode=0;
...
t_Open9xx9dMixData_v212::operator MixData ()
{
  MixData c9x;
  if (srcRaw) {
    c9x.destCh = destCh+1;
    ...
    else if (srcRaw <= 14+9+O9X_X9D_NUM_CSW) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_SWITCH, open9xx9dToSwitch(srcRaw-14).toValue());
    }
    else if (srcRaw <= 14+9+O9X_X9D_NUM_CSW+NUM_CYC) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_CYC, srcRaw-15-9-O9X_X9D_NUM_CSW);
    }
    else if (srcRaw <= 14+9+O9X_X9D_NUM_CSW+NUM_CYC+NUM_PPM) {
      c9x.srcRaw = RawSource(SOURCE_TYPE_PPM, srcRaw-15-9-O9X_X9D_NUM_CSW-NUM_CYC);
    }
    else {
      c9x.srcRaw = RawSource(SOURCE_TYPE_CH, srcRaw-15-9-O9X_X9D_NUM_CSW-NUM_CYC-NUM_PPM);
    }
    c9x.weight = weight;
    if (curveMode==0) {
...
t_Open9xx9dMixData_v213::t_Open9xx9dMixData_v213(MixData &c9x)
{
  if (c9x.destCh) {
    destCh = c9x.destCh-1;
    mixWarn = c9x.mixWarn;
    ...
    memset(this, 0, sizeof(t_Open9xx9dMixData_v213));
  }
}

t_Open9xx9dMixData_v213::operator MixData ()
{
  MixData c9x;
  if (srcRaw) {
    c9x.destCh = destCh+1;
...
t_Open9xx9dCustomSwData_v208::t_Open9xx9dCustomSwData_v208(CustomSwData &c9x)
{
  func = c9x.func;
  v1 = c9x.val1;
  v2 = c9x.val2;
  ...
  if ((c9x.func >= CS_VPOS && c9x.func <= CS_ANEG) || c9x.func >= CS_EQUAL) {
    v1 = open9xx9d208FromSource(RawSource(c9x.val1));
  }

  if (c9x.func >= CS_EQUAL) {
    v2 = open9xx9d208FromSource(RawSource(c9x.val2));
  }

  if (c9x.func >= CS_AND && c9x.func <= CS_XOR) {
    v1 = open9xx9dFromSwitch(RawSwitch(c9x.val1));
    v2 = open9xx9dFromSwitch(RawSwitch(c9x.val2));
  }
  
  if (func>O9X_X9D_MAX_CSFUNCOLD ) {
...
t_Open9xx9dCustomSwData_v208::operator CustomSwData ()
{
  CustomSwData c9x;
  c9x.func = func;
  c9x.val1 = v1;
  ...
  if ((c9x.func >= CS_VPOS && c9x.func <= CS_ANEG) || c9x.func >= CS_EQUAL) {
    c9x.val1 = open9xx9d208ToSource(v1).toValue();
  }

  if (c9x.func >= CS_EQUAL) {
    c9x.val2 = open9xx9d208ToSource(v2).toValue();
  }

  if (c9x.func >= CS_AND && c9x.func <= CS_XOR) {
    c9x.val1 = open9xx9dToSwitch(v1).toValue();
    c9x.val2 = open9xx9dToSwitch(v2).toValue();
  }

  return c9x;
}

t_Open9xx9dCustomSwData_v209::t_Open9xx9dCustomSwData_v209(CustomSwData &c9x)
{
  func = c9x.func;
  v1 = c9x.val1;
  v2 = c9x.val2;
  ...
  if ((c9x.func >= CS_VPOS && c9x.func <= CS_ANEG) || c9x.func >= CS_EQUAL) {
    v1 = open9xx9d209FromSource(RawSource(c9x.val1));
  }

  if (c9x.func >= CS_EQUAL) {
    v2 = open9xx9d209FromSource(RawSource(c9x.val2));
  }
...
t_Open9xx9dCustomSwData_v209::operator CustomSwData ()
{
  CustomSwData c9x;
  c9x.func = func;
  c9x.val1 = v1;
  ...
  if ((c9x.func >= CS_VPOS && c9x.func <= CS_ANEG) || c9x.func >= CS_EQUAL) {
    c9x.val1 = open9xx9d209ToSource(v1).toValue();
  }

  if (c9x.func >= CS_EQUAL) {
    c9x.val2 = open9xx9d209ToSource(v2).toValue();
  }
...
t_Open9xx9dCustomSwData_v210::t_Open9xx9dCustomSwData_v210(CustomSwData &c9x)
{
  func = c9x.func;
  v1 = c9x.val1;
  v2 = c9x.val2;
  ...
  if ((c9x.func >= CS_VPOS && c9x.func <= CS_ANEG) || c9x.func >= CS_EQUAL) {
    v1 = open9xx9d210FromSource(RawSource(c9x.val1));
  }

  if (c9x.func >= CS_EQUAL && c9x.func <= CS_ELESS) {
    v2 = open9xx9d210FromSource(RawSource(c9x.val2));
  }
...
t_Open9xx9dCustomSwData_v210::operator CustomSwData ()
{
  CustomSwData c9x;
  c9x.func = func;
  c9x.val1 = v1;
  ...
  if ((c9x.func >= CS_VPOS && c9x.func <= CS_ANEG) || c9x.func >= CS_EQUAL) {
    c9x.val1 = open9xx9d210ToSource(v1).toValue();
  }

  if (c9x.func >= CS_EQUAL && c9x.func <= CS_ELESS) {
    c9x.val2 = open9xx9d210ToSource(v2).toValue();
  }
...
t_Open9xx9dFuncSwData_v208::t_Open9xx9dFuncSwData_v208(FuncSwData &c9x)
{
  swtch = open9xx9dFromSwitch(c9x.swtch);
...
t_Open9xx9dFuncSwData_v208::operator FuncSwData ()
{
  FuncSwData c9x;
  c9x.swtch = open9xx9dToSwitch(swtch);
...
t_Open9xx9dFuncSwData_v210::t_Open9xx9dFuncSwData_v210(FuncSwData &c9x)
{
  swtch = open9xx9dFromSwitch(c9x.swtch);
  uint32_t value;
...
t_Open9xx9dFuncSwData_v210::operator FuncSwData ()
{
  FuncSwData c9x;
  c9x.swtch = open9xx9dToSwitch(swtch);
  c9x.func = (AssignFunc)(func);
...
t_Open9xx9dFuncSwData_v211::t_Open9xx9dFuncSwData_v211(FuncSwData &c9x)
{
  swtch = open9xx9dFromSwitch(c9x.swtch);
  uint32_t value;
  if (c9x.func <= FuncInstantTrim) {
...
t_Open9xx9dFuncSwData_v211::operator FuncSwData ()
{
  FuncSwData c9x;
  c9x.swtch = open9xx9dToSwitch(swtch);
  c9x.func = (AssignFunc)(func);
...
t_Open9xx9dSwashRingData_v208::t_Open9xx9dSwashRingData_v208(SwashRingData &c9x)
{
  invertELE = c9x.invertELE;
  invertAIL = c9x.invertAIL;
  invertCOL = c9x.invertCOL;
  type = c9x.type;
  collectiveSource = open9xx9d208FromSource(c9x.collectiveSource);
  value = c9x.value;
}

t_Open9xx9dSwashRingData_v208::operator SwashRingData ()
{
  SwashRingData c9x;
  ...
  c9x.type = type;
  c9x.collectiveSource = open9xx9d208ToSource(collectiveSource);
  c9x.value = value;
  return c9x;
}

t_Open9xx9dSwashRingData_v209::t_Open9xx9dSwashRingData_v209(SwashRingData &c9x)
{
  invertELE = c9x.invertELE;
  invertAIL = c9x.invertAIL;
  invertCOL = c9x.invertCOL;
  type = c9x.type;
  collectiveSource = open9xx9d209FromSource(c9x.collectiveSource);
  value = c9x.value;
}

t_Open9xx9dSwashRingData_v209::operator SwashRingData ()
{
  SwashRingData c9x;
  c9x.invertELE = invertELE;
  c9x.invertAIL = invertAIL;
  c9x.invertCOL = invertCOL;
  c9x.type = type;
  c9x.collectiveSource = open9xx9d209ToSource(collectiveSource);
  c9x.value = value;
  return c9x;
}

t_Open9xx9dSwashRingData_v210::t_Open9xx9dSwashRingData_v210(SwashRingData &c9x)
{
  invertELE = c9x.invertELE;
  invertAIL = c9x.invertAIL;
  invertCOL = c9x.invertCOL;
  type = c9x.type;
  collectiveSource = open9xx9d210FromSource(c9x.collectiveSource);
  value = c9x.value;
}

t_Open9xx9dSwashRingData_v210::operator SwashRingData ()
{
  SwashRingData c9x;
  c9x.invertELE = invertELE;
  c9x.invertAIL = invertAIL;
  c9x.invertCOL = invertCOL;
  c9x.type = type;
  c9x.collectiveSource = open9xx9d210ToSource(collectiveSource);
  c9x.value = value;
  return c9x;
}

t_Open9xx9dFrSkyData_v210::operator FrSkyData ()
{
  FrSkyData c9x;
...
t_Open9xx9dFrSkyData_v210::t_Open9xx9dFrSkyData_v210(FrSkyData &c9x)
{
  memset(this, 0, sizeof(t_Open9xx9dFrSkyData_v210));
...
t_Open9xx9dFrSkyData_v211::operator FrSkyData ()
{
  FrSkyData c9x;
  c9x.channels[0] = channels[0];
  c9x.channels[1] = channels[1];
...
t_Open9xx9dFrSkyData_v211::t_Open9xx9dFrSkyData_v211(FrSkyData &c9x)
{
  memset(this, 0, sizeof(t_Open9xx9dFrSkyData_v211));
  channels[0] = c9x.channels[0];
  channels[1] = c9x.channels[1];
  usrProto = c9x.usrProto;
  voltsSource = c9x.voltsSource;
...
t_Open9xx9dFrSkyData_v213::operator FrSkyData ()
{
  FrSkyData c9x;
  c9x.channels[0] = channels[0];
  c9x.channels[1] = channels[1];
...
t_Open9xx9dFrSkyData_v213::t_Open9xx9dFrSkyData_v213(FrSkyData &c9x)
{
  memset(this, 0, sizeof(t_Open9xx9dFrSkyData_v213));
  channels[0] = c9x.channels[0];
  channels[1] = c9x.channels[1];
  usrProto = c9x.usrProto;
  voltsSource = c9x.voltsSource;
...
t_Open9xx9dModelData_v208::operator ModelData ()
{
  ModelData c9x;
  c9x.used = true;
  getEEPROMZString(c9x.name, name, sizeof(name));
  ...
  for (int i=0; i<O9X_X9D_MAX_MIXERS; i++)
    c9x.mixData[i] = mixData[i];
  for (int i=0; i<O9X_X9D_NUM_CHNOUT; i++)
    c9x.limitData[i] = limitData[i];
  for (int i=0; i<O9X_X9D_MAX_EXPOS; i++)
  ...
  for (int i=0; i<O9X_X9D_NUM_CSW; i++)
    c9x.customSw[i] = customSw[i];
  for (int i=0; i<O9X_X9D_NUM_FSW; i++)
...
t_Open9xx9dModelData_v208::t_Open9xx9dModelData_v208(ModelData &c9x)
{
...
/* TODO   for (int i=0; i<MAX_CURVE5; i++)
    ...
    for (int i=0; i<O9X_X9D_NUM_CHNOUT; i++) {
      if (c9x.safetySw[i].swtch.type) {
        funcSw[count].func = i;
        funcSw[count].swtch = open9xx9dFromSwitch(c9x.safetySw[i].swtch);
    ...
    memset(this, 0, sizeof(t_Open9xx9dModelData_v208));
  }
}

t_Open9xx9dModelData_v209::operator ModelData ()
{
  ModelData c9x;
  c9x.used = true;
  getEEPROMZString(c9x.name, name, sizeof(name));
...
t_Open9xx9dModelData_v209::t_Open9xx9dModelData_v209(ModelData &c9x)
{
  ...
  memset(this, 0, sizeof(t_Open9xx9dModelData_v209));
...
t_Open9xx9dModelData_v210::operator ModelData ()
{
  ModelData c9x;
  c9x.used = true;
  getEEPROMZString(c9x.name, name, sizeof(name));
...
t_Open9xx9dModelData_v210::t_Open9xx9dModelData_v210(ModelData &c9x)
{
  ...
  memset(this, 0, sizeof(t_Open9xx9dModelData_v210));
...
t_Open9xx9dModelData_v211::operator ModelData ()
{
  ModelData c9x;
  c9x.used = true;
  getEEPROMZString(c9x.name, name, sizeof(name));
  ...
  for (int i=0; i<O9X_X9D_MAX_EXPOS; i++)
    c9x.expoData[i] = expoData[i];
  for (int i=0; i<O9X_X9D_MAX_CURVES; i++) {
...
#define MODEL_DATA_SIZE_X9D_211 3585
t_Open9xx9dModelData_v211::t_Open9xx9dModelData_v211(ModelData &c9x)
{
  if (sizeof(*this) != MODEL_DATA_SIZE_X9D_211) {
    QMessageBox::warning(NULL, "companion9x", QString("Open9xModelData wrong size (%1 instead of %2)").arg(sizeof(*this)).arg(MODEL_DATA_SIZE_X9D_211));
  }

  memset(this, 0, sizeof(t_Open9xx9dModelData_v211));
  ...
  if (c9x.used) {
    ...
    for (int i=0; i<O9X_X9D_MAX_CURVES; i++) {
      ...
      if (offset > O9X_X9D_NUM_POINTS - 5 * O9X_X9D_MAX_CURVES) {
        EEPROMWarnings += ::QObject::tr("open9x only accepts %1 points in all curves").arg(O9X_X9D_NUM_POINTS) + "\n";
        break;
      }
      curves[i] = offset;
...
t_Open9xx9dModelData_v212::operator ModelData ()
{
  ModelData c9x;
  c9x.used = true;
  getEEPROMZString(c9x.name, name, sizeof(name));
...
t_Open9xx9dModelData_v212::t_Open9xx9dModelData_v212(ModelData &c9x)
{
  ...
  memset(this, 0, sizeof(t_Open9xx9dModelData_v212));
...
t_Open9xx9dModelData_v213::operator ModelData ()
{
  ModelData c9x;
  c9x.used = true;
  getEEPROMZString(c9x.name, name, sizeof(name));
...
#define MODEL_DATA_SIZE_213 3352
t_Open9xx9dModelData_v213::t_Open9xx9dModelData_v213(ModelData &c9x)
{
  ...
  memset(this, 0, sizeof(t_Open9xx9dModelData_v213));
