...
void RegisterOpen9xFirmwares()
{
  ...
  Option ext_options[] = { { "frsky", QObject::tr("Support for frsky telemetry mod"), FRSKY_VARIANT }, { "telemetrez", QObject::tr("Support for telemetry easy board"), FRSKY_VARIANT }, { "jeti", QObject::tr("Support for jeti telemetry mod"), 0 }, { "ardupilot", QObject::tr("Support for receiving ardupilot data"), 0 }, { "nmea", QObject::tr("Support for receiving NMEA data"), 0 }, { "mavcopter", QObject::tr("Support for MAVLINK Copters devices"), 0 },{ "mavplane", QObject::tr("Support for MAVLINK Plane devices"), 0 }, { NULL } };
  ...
  Option extr_options[] = { { "frsky", QObject::tr("Support for frsky telemetry mod"), FRSKY_VARIANT }, { "jeti", QObject::tr("Support for jeti telemetry mod"), 0 }, { "ardupilot", QObject::tr("Support for receiving ardupilot data"), 0 }, { "nmea", QObject::tr("Support for receiving NMEA data"), 0 }, { "mavcopter", QObject::tr("Support for MAVLINK Copters devices"), 0 },{ "mavplane", QObject::tr("Support for MAVLINK Plane devices"), 0 }, { NULL } };
