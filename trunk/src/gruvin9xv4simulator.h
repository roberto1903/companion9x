...
#ifndef gruvin9xv4_simulator_h
#define gruvin9xv4_simulator_h

#include "simulatorinterface.h"

class RadioData;
class Gruvin9xInterface;

class Gruvin9xV4Simulator : public SimulatorInterface {

  public:

    Gruvin9xV4Simulator(Gruvin9xInterface *);
