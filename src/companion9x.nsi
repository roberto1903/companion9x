...
;Include Modern UI
  ...
  !include "MUI2.nsh"
  !include "/mnt/hgfs/Perso/workspace/companion9x/src\..\winbuild\FileAssociation.nsh"
...
;General
  ...
  ;Name and file
  Name "companion9x"
  OutFile "companion9xInstall_v0.11.exe"
...
;Pages
  ...
  !insertmacro MUI_PAGE_LICENSE "/mnt/hgfs/Perso/workspace/companion9x/src\..\winbuild\license.txt"
...
Section "companion9x" SecDummy
  ...
  File "/mnt/hgfs/Perso/workspace/companion9x/src\..\winbuild\license.txt"
  ...
  File "/mnt/hgfs/Perso/workspace/companion9x/src\..\winbuild\avrdude.exe"
  File "/mnt/hgfs/Perso/workspace/companion9x/src\..\winbuild\avrdude.conf"
  File "/mnt/hgfs/Perso/workspace/companion9x/src\..\winbuild\libusb0.dll"
