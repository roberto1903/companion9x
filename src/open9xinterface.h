...
class Open9xFirmware: public FirmwareInfo
{
  public:
    ...
    Open9xFirmware(const QString & id, const QString & name, EEPROMInterface * eepromInterface, QString url, const char * stamp):
      FirmwareInfo(id, name, eepromInterface, url, stamp)
    {
    }
